...
<head>
    ...
    <script>
        ...
        function login() {
            ...
            if ($("input[type='radio']:checked").val() == "system") {
                //去后台验证登录相关操作
                $.ajax({

                    url : "settings/account/login.do?type=system",
                    data : {
            ...
            else if ($("input[type='radio']:checked").val() == "dorm"){

                /*alert("dorm");*/
                //去后台验证登录相关操作
                $.ajax({

                    url : "settings/account/login.do?type=dorm",
                    data : {
            ...
            <div class="form-group form-group-lg">
                ...
                <div class="form-group" style="position: relative;top: 30px; left: 20px;">
                    <label class="radio-inline">
                        <input type="radio" name="type" checked value="system" class="radio-inline"> 系统管理员
                    </label>
                    <label class="radio-inline">
                        <input type="radio" name="type" value="dorm" class="radio-inline" > 宿舍管理员
                    </label>
                </div>
