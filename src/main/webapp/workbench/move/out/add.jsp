    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $.ajax({
                ...
                url : "workbench/move/out/getStuNameId.do",
                data : { },
                type : "get",
                dataType : "json",
            ...
            $("#saveBtn").click(function () {
                ...
                $.ajax({
                    ...
                    url : "workbench/move/out/save.do",
                    data : {

                        "stuId" : $.trim($("#create-stu").val()),
                        "state" : $.trim($("#create-state").val()),
                        "outDate" : $.trim($("#create-date").val())
                    ...
                    success : function (data) {
                        ...
                        if(data.success){
                            ...
                            html +='  Move Out  '+$("#create-stu option:selected").text()+'   '+$("#create-state").val();
                            html +='  迁出日期  '+$("#create-date").val();
                            html += '</tr>';
...
<div class="modal-body">
    ...
    <div class="btn-toolbar" role="toolbar" style="height: 80px;">
        <form id="activityAddForm" class="form-horizontal" role="form">
            ...
            <div class="form-group">
                <label for="create-startTime" class="col-sm-2 control-label">迁出原因</label>
                <div class="col-sm-10" style="width: 300px;">
                ...
                <label for="create-endTime" class="col-sm-2 control-label">迁出日期</label>
                <div class="col-sm-10" style="width: 300px;">
